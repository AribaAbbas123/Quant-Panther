...
const Team = () => {
  return (
    <>
        ...
        <h1 className='text-white bold text-[55px] text-center'>Our T<span className='text-purple'>eam</span></h1>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-20'>
              <div className='grid-row' >
                <div className='team1 relative'>
                  ...
                  <h1 className='text-pClr regular text-base absolute team1-main border-left-h'>Founder/ <br />Lead Developer</h1>
                  <img src={team1} className='absolute team1-main team1-img' />
                  <img src={bRight} className='absolute team1-main border-right' />
                  <h1 className='text-pClr absolute team1-main border-right-h semiBold text-xl'>Manav Bajaj</h1>
                </div>
              </div>
              {/* 2 */}
              <div className='grid-row'> <div className='team1 relative'>
                <img src={bLeft} className='absolute team1-main border-left-2' />
                <h1 className='text-pClr regular text-base absolute team1-main border-left-h'>Co Founder <br />
                  COO</h1>
                <img src={team2} className='absolute team1-main team1-img' />
                <img src={bRight} className='absolute team1-main border-right' />
                <h1 className='text-pClr absolute team1-main border-right-h semiBold text-xl'>Chandni Shah</h1>
              </div></div>
              {/* 3 */}
              <div className='grid-row'> <div className='team1 relative'>
                <img src={bLeft} className='absolute team1-main border-left-2' />
                <h1 className='text-pClr regular text-base absolute team1-main border-left-h-3'>AI Programmer</h1>
                <img src={team3} className='absolute team1-main team1-img' />
                <img src={bRight} className='absolute team1-main border-right-3' />
                <h1 className='text-pClr absolute team1-main border-right-h-3 semiBold text-xl'>Bhavya Gulati</h1>
              </div></div>
              {/* 4 */}
              <div className='grid-row'>
                <div className='team1 relative'>
                  <img src={bLeft} className='absolute team1-main border-left' />
                  <h1 className='text-pClr regular text-base absolute team1-main border-left-h'>Blockchain <br />Developer</h1>
                  <img src={team4} className='absolute team1-main team1-img' />
                  <img src={bRight} className='absolute team1-main border-right' />
                  <h1 className='text-pClr absolute team1-main border-right-h semiBold text-xl'>Rajesh GV</h1>
                </div>
              </div>
              {/* 5 */}
              <div className='grid-row'> <div className='team1 relative'>
                <img src={bLeft} className='absolute team1-main border-left-2' />
                <h1 className='text-pClr regular text-base absolute team1-main border-left-h'>Business <br />Development</h1>
                <img src={team5} className='absolute team1-main team1-img' />
                <img src={bRight} className='absolute team1-main border-right' />
                <h1 className='text-pClr absolute team1-main border-right-h semiBold text-xl'>Rishabh Kalra</h1>
              </div></div>
              {/* 6 */}
              <div className='grid-row'> <div className='team1 relative'>
                <img src={bLeft} className='absolute team1-main border-left-2' />
                <h1 className='text-pClr regular text-base absolute team1-main border-left-h-3'>Marketing Head</h1>
                <img src={team6} className='absolute team1-main team1-img' />
                <img src={bRight} className='absolute team1-main border-right-3' />
                <h1 className='text-pClr absolute team1-main border-right-h-3 semiBold text-xl'>Ajay Kumar</h1>
              </div></div>
            </div>
